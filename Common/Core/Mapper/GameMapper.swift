...
public class GameMapper {
    public static func mapGameCatalogResponsetoEntity(gameResponse: [GameDataResponse]) -> [GameCatalogEntity] {
    ...
    public static func mapGameCatalogEntityToDomainModel(gameEntity: [GameCatalogEntity]) -> [GameModel] {
    ...
    public static func mapGameDetailResponsetoEntity(gameResponse: GameDetailsResponse) -> GameCatalogEntity {
        var entity = GameCatalogEntity()
    ...
    public static func mapGameDetailEntityToDomainModel(gameEntity: GameCatalogEntity) -> GameModel {
        var model = GameModel()
