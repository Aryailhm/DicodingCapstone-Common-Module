...
public class WishlistMapper {
    public static func mapWishlistEntityToDomainModel(wishlists: [WishlistEntity]) -> [GameModel] {
    ...
    public static func mapGameDomainModelToWishlistEntity(game: GameModel) -> WishlistEntity {
